...
<body class="g-sidenav-show  bg-gray-200">
    <aside
        ...
        data-image="../assets/img/sidebar-2.jpg" id="sidenav-main">
        <div class="sidenav-header">
            <i class="fas fa-times p-3 cursor-pointer text-black opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
                aria-hidden="true" id="iconSidenav"></i>
            <a class="navbar-brand m-0" href="http://127.0.0.1:8000/dashboard">
                {{-- <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo"> --}}
                <span class="ms-3 font-weight-bold text-red" style="font-size: 2rem;">Pursell</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ 'review-management' == request()->path() ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Review Management</span>
                    </a>
                </li>
            </ul>
        </div>
                ...
                <div class="collapse navbar-collapse justify-content-end">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown"
                                class="nav-link dropdown-toggle btn btn-white btn-round btn-just-icon" href="#"
